...
type CategoryServiceClient interface {
	...
	ListCategories(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoriesResponse, error)
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*CategoriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CategoryServiceServer interface {
	...
	ListCategories(context.Context, *Empty) (*CategoriesResponse, error)
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *Empty) (*CategoriesResponse, error) {
